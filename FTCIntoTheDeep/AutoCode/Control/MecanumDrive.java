package org.firstinspires.ftc.teamcode.FTCIntoTheDeep.AutoCode.Control;

import org.firstinspires.ftc.teamcode.FTCIntoTheDeep.DeepDrive.IntoTheDeepDriveBase;
import org.firstinspires.ftc.teamcode.FTCIntoTheDeep.DeepDrive.DriveTrain;
...
{
    public static void cartesian(IntoTheDeepDriveBase driveTrain, double main, double strafe, double turn)
    {
...
//    }
    ...
    public static MotorPowers calcPolar(double mag, double dir, double rot)
    {
        ...
        //Compute the powter for each wheel
